...
INSERT INTO tp4_bdd2.auteur VALUES (1, 2);
INSERT INTO tp4_bdd2.auteur VALUES (2, 4);
...
INSERT INTO tp4_bdd2.categorie VALUES (1, 'Famille');
INSERT INTO tp4_bdd2.categorie VALUES (2, 'Jeu de soci�t�');
...
INSERT INTO tp4_bdd2.creer VALUES (1, 1);
INSERT INTO tp4_bdd2.creer VALUES (2, 2);
...
INSERT INTO tp4_bdd2.employe VALUES (1, 1);
...
INSERT INTO tp4_bdd2.festival VALUES (1, 1, 1, 'Lille Fest', '2021-03-01', '2021-03-06');
INSERT INTO tp4_bdd2.festival VALUES (2, 2, 1, 'Mons-en-Baroeul Fest', '2021-05-12', '2021-05-20');
...
INSERT INTO tp4_bdd2.jeux VALUES (1, 1, 'Jengga');
INSERT INTO tp4_bdd2.jeux VALUES (2, 2, 'Monopoly');
...
INSERT INTO tp4_bdd2.participant VALUES (1, 3);
INSERT INTO tp4_bdd2.participant VALUES (2, 5);
...
INSERT INTO tp4_bdd2.pays VALUES ('France');
INSERT INTO tp4_bdd2.pays VALUES ('Indonesie');
INSERT INTO tp4_bdd2.pays VALUES ('Belgique');
...
INSERT INTO tp4_bdd2.personne VALUES (1, 'Indonesie', 'Rachmat', 'Benedictus Kent', 'benedictuskent.rachmat.etu@univ-lille.fr');
INSERT INTO tp4_bdd2.personne VALUES (2, 'France', 'Bourahma', 'Aziz', 'aziz.bourahma.etu@univ-lille.fr');
INSERT INTO tp4_bdd2.personne VALUES (3, 'France', 'Duvivier', 'Corentin', 'corentin.duvivier.etu@univ-lille.fr');
INSERT INTO tp4_bdd2.personne VALUES (4, 'France', 'Abraham', 'Dorian', 'dorian.abraham.etu@univ-lille.fr');
INSERT INTO tp4_bdd2.personne VALUES (5, 'Belgique', 'Thomas', 'Louis', 'louis.thomas.etu@univ-lille.fr');
...
INSERT INTO tp4_bdd2.session VALUES (1, 1, 1, 1, '2021-03-02', 6, 12, 1);
INSERT INTO tp4_bdd2.session VALUES (2, 1, 2, 2, '2021-03-05', 7, 8, 2);
INSERT INTO tp4_bdd2.session VALUES (3, 2, 2, 2, '2021-03-14', 6, 12, 1);
INSERT INTO tp4_bdd2.session VALUES (4, 2, 1, 1, '2021-03-19', 8, 9, 4);
...
INSERT INTO tp4_bdd2.ville VALUES (1, 'Lille');
INSERT INTO tp4_bdd2.ville VALUES (2, 'Mons-en-Baroeul');
...
SELECT pg_catalog.setval('tp4_bdd2.auteur_num_aut_seq', 2, true);
...
SELECT pg_catalog.setval('tp4_bdd2.categorie_num_categ_seq', 2, true);
...
SELECT pg_catalog.setval('tp4_bdd2.employe_num_emp_seq', 1, true);
...
SELECT pg_catalog.setval('tp4_bdd2.festival_num_fest_seq', 2, true);
...
SELECT pg_catalog.setval('tp4_bdd2.jeux_num_jeu_seq', 2, true);
...
SELECT pg_catalog.setval('tp4_bdd2.participant_num_part_seq', 2, true);
...
SELECT pg_catalog.setval('tp4_bdd2.personne_num_pers_seq', 5, true);
...
SELECT pg_catalog.setval('tp4_bdd2.session_num_session_seq', 4, true);
...
SELECT pg_catalog.setval('tp4_bdd2.ville_num_ville_seq', 2, true);
