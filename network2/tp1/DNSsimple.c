 ...
 * Ajour d'une version sans getaddrinfo suite aux questions                            - Laurent NOE - Fevrier 2021
 ...
 * - il est autrement possible  de r̩aliser une version "en dur" via la structure   (struct sockaddr) remote_addr
 */
#define GETADDRINFO
...
int main(void) {
    ...
    // adresse distante (et port) : pas de r̩solution ici
 ...
 /*
    ...
    // et on laisse le syst̬me choisir un port dynamique sans l'imposer (htons(0))
